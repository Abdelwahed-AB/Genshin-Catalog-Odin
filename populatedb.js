...
var createWeapon = (name, base_attack, second_stat, passive, rarity, weapon_type, img, cb)=>{
    let weap = new Weapon({name, base_attack, second_stat, passive, rarity, weapon_type, img});
